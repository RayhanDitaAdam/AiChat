                ...
                <div className="bg-rose-50 border border-rose-100 p-6 rounded-[2rem] flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-rose-700/80 font-medium mt-1">
                            Your store locaton is not yet configured. Customers may not be able to find you on the map.
                            Please add your store location below.
                        </p>
                    </div>
                </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 space-y-6">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-xl font-black text-slate-800">Store Identity</h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-slate-700 ml-1">Store Name</label>
                            <input
                                type="text"
                                value={formData.name}
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-slate-700 ml-1">Store URL (Slug)</label>
                            <input
                                type="text"
                ...
                <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 space-y-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-xl font-black text-slate-800">Store Location</h2>
                        </div>
                    ...
                    <div className="h-[400px] w-full rounded-[2rem] overflow-hidden border-4 border-slate-50 shadow-inner relative z-0">
                        ...
                        <div className="absolute bottom-4 left-4 z-[1000] bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl border border-slate-200 shadow-sm flex items-center gap-2">
                            ...
                            <p className="text-[10px] font-bold text-slate-600">
                                {isEditing ? 'Click on map to pick location' : 'Map View (Locked)'}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-end pt-4">
                    <button
                        type="submit"
                        disabled={loading}
                        className="flex items-center gap-3 px-10 py-4 bg-slate-900 text-white font-black rounded-[1.5rem] hover:bg-slate-800 transition-all shadow-xl shadow-slate-200 disabled:opacity-50"
                    >
                        {loading ? (
