...
export class EmailService {
    ...
    private static getFooterHtml(to: string, companyName: string): string {
        return `
    ...
    private static wrapHtml(content: string, to: string, companyName: string): string {
        return `
     ...
     */
    static async sendReminderEmail(to: string, name: string, eventContent: string) {
        const companyName = await this.getCompanyName();
