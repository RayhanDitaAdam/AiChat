...
router.get(
    "/my-requests",
    authenticate,
    contributorController.getMyRequests
);

router.post(
    "/request",
    authenticate,
    contributorRequestLimiter,
    validate(createContributorRequestSchema),
    contributorController.createRequest
);

router.delete(
    "/requests/:requestId",
    authenticate,
    contributorController.deleteRequest
);
...
router.get(
    "/requests",
    authenticate,
    contributorController.getPendingRequests
);

router.put(
    "/requests/:requestId",
    authenticate,
    validate(updateContributorRequestStatusSchema),
    contributorController.updateRequestStatus
);
