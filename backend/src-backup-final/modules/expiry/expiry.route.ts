...
router.get('/', (req, res) =>
    expiryController.getExpiries(req, res)
);

router.post('/', (req, res) =>
    expiryController.createExpiry(req, res)
);

router.delete('/:id', (req, res) =>
    expiryController.deleteExpiry(req, res)
);

router.post('/:id/products', (req, res) =>
    expiryController.assignProduct(req, res)
);

router.delete('/:id/products/:productId', (req, res) =>
    expiryController.removeProduct(req, res)
);
