...
router.get("/public", (req, res) =>
  vacancyController.getAllVacancies(req, res),
);
...
router.post(
  ...
  (req, res) => vacancyController.createVacancy(req, res),
);
...
router.patch(
  ...
  (req, res) => vacancyController.updateVacancy(req, res),
);
...
router.get("/my-applications", authenticate, (req, res) =>
  vacancyController.getUserApplications(req, res),
);
