...
export class VacancyController {
  ...
  async applyToVacancy(req, res) {
    try {
      ...
      const result = await vacancyService.applyToVacancy(
        req.user.id,
        vacancyId,
        reason,
      );
  ...
  async getAllApplicants(req, res) {
    try {
      ...
      const result = await vacancyService.getAllApplicantsForOwner(
        req.user.ownerId,
      );
      return res.json(result);
    } catch (error) {
  ...
  async getApplicants(req, res) {
    try {
      ...
      const vacancyId = req.params.vacancyId;
      const result = await vacancyService.getApplicantsForVacancy(
        req.user.ownerId,
        vacancyId,
      );
      return res.json(result);
  ...
  async updateApplicationStatus(req, res) {
    try {
      ...
      const result = await vacancyService.updateApplicationStatus(
        req.user.ownerId,
        id,
        status,
      );
