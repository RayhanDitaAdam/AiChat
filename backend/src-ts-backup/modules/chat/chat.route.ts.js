...
// Existing routes
router.post("/", authenticateOptional, validate(ChatSchema), (req, res) =>
...
router.patch("/sessions/:sessionId/pin", authenticate, (req, res) =>
  chatController.toggleSessionPin(req, res),
);
...
router.get("/store-staff/:ownerId", authenticateOptional, (req, res) =>
  chatController.getStoreStaff(req, res),
);
...
router.post("/accept-call", authenticate, (req, res) =>
  chatController.acceptCall(req, res),
);
router.post("/decline-call", authenticate, (req, res) =>
  chatController.declineCall(req, res),
);

// NEW: Management AI Chat
router.post("/management", authenticate, (req, res) =>
  managementChatController.chat(req, res),
);
