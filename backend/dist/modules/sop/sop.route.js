...
router.post('/upload', documentUpload.single('file'), (req, res) => sopController.uploadSop(req, res));
router.get('/', (req, res) => sopController.getSops(req, res));
router.delete('/:id', (req, res) => sopController.deleteSop(req, res));
router.put('/:id', (req, res) => sopController.updateSopText(req, res));
export default router;
//# sourceMappingURL=sop.route.js.map