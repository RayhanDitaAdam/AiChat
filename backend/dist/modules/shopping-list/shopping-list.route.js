...
import { AddToShoppingListSchema } from './shopping-list.schema.js';
...
router.delete('/items/:itemId', authenticate, (req, res) => controller.removeItem(req, res));
export default router;
//# sourceMappingURL=shopping-list.route.js.map