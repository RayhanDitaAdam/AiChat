...
router.post('/verify-key-file', (req, res) => authController.verifyKeyFile(req, res));
...
router.post('/forgot-password', authRateLimit, validate(ForgotPasswordSchema), (req, res) => authController.forgotPassword(req, res));
router.get('/validate-reset-token', (req, res) => authController.validateToken(req, res));
router.post('/reset-password', authRateLimit, validate(ResetPasswordSchema), (req, res) => authController.resetPassword(req, res));
...
router.post('/2fa/login', authRateLimit, (req, res) => authController.login2FA(req, res));
router.post('/2fa/resend', authRateLimit, (req, res) => authController.resend2FA(req, res));
