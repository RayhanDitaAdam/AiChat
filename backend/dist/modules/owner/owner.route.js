...
router.get('/missing-request/:ownerId', authenticate, requireStaffOrOwner(), requireApproved(), requireOwnData(), (req, res) => ownerController.getMissingRequests(req, res));
router.get('/ratings/:ownerId', authenticate, requireStaffOrOwner(), requireApproved(), requireOwnData(), (req, res) => ownerController.getRatings(req, res));
router.get('/chat-history/:ownerId', authenticate, requireStaffOrOwner(), requireApproved(), requireOwnData(), (req, res) => ownerController.getChatHistory(req, res));
// Live Support Routes - Allow Staff or Owner
router.get('/owner/live-support', authenticate, requireStaffOrOwner(), requireApproved(), (req, res) => ownerController.getLiveSupportSessions(req, res));
router.post('/owner/live-support/respond', authenticate, requireStaffOrOwner(), requireApproved(), (req, res) => ownerController.respondToChat(req, res));
router.get('/owner/live-support/:userId', authenticate, requireStaffOrOwner(), requireApproved(), (req, res) => ownerController.getLiveChatHistory(req, res));
...
router.get('/owner/config', authenticate, requireOwner(), requireApproved(), (req, res) => ownerController.getOwnerConfig(req, res));
router.patch('/owner/config', authenticate, requireOwner(), requireApproved(), (req, res) => ownerController.updateOwnerConfig(req, res));
