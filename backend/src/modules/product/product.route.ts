...
router.post('/', authenticate, requireStaffOrOwner(), requireApproved(), productImageUpload, (req, res) =>
    productController.createProduct(req, res)
);

router.patch('/:id', authenticate, requireStaffOrOwner(), requireApproved(), productImageUpload, (req, res) =>
...
router.get('/owner/pending', authenticate, requireOwner(), requireApproved(), (req, res) =>
