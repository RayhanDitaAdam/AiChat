...
export class KnowledgeBaseService {
    ...
    async createCategory(ownerId: string, name: string, description?: string) {
        const data: any = { ownerId, name };
    ...
    async getFaqs(ownerId: string, categoryId?: string, search?: string) {
    ...
    async createFaq(ownerId: string, data: {
        question: string;
        answer: string;
        alternatives?: string[];
        priority?: number;
    ...
    async updateFaq(id: string, ownerId: string, data: any) {
    ...
    async deleteFaq(id: string, ownerId: string) {
     ...
     */
    private async syncFaqToVectorHub(faqId: string) {
