...
export class ActionService {
    ...
    async execute(intent: string, message: string, userId?: string, ownerId?: string): Promise<string | null> {
    ...
    private async handleOrderStatus(message: string, userId?: string, ownerId?: string): Promise<string> {
