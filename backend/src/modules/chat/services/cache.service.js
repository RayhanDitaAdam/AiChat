...
export class CacheService {
    // Simple in-memory cache for fallback when Redis is not available
     __init() {this.memoryCache = new Map()}
     __init2() {this.redisClient = null} // To be implemented when Redis is deployed

    constructor() {;CacheService.prototype.__init.call(this);CacheService.prototype.__init2.call(this);
        this.connectRedis();
    }
